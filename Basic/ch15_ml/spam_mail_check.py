...
from ch15_ml.svm_titanic import prediction
...
print('변수 subject 이메일의 제목, label은 스팸 여부 문자열입니다.')
...
print(f'종속 변수(스팸 여부) {num_to_show}개 보기')
...
for new_email in test_mail_list:
    ...
    result = f"'{prediction[0]}' 메일 : {new_email}" # 결과 출력
    print(result)
