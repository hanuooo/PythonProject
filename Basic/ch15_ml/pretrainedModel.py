...
model = VGG16()
print(model.summary())
# 입력 : (None, 224, 224, 3) 크리 224*224 컬러이미지
...
file_list = os.listdir(image_source) # dir : 디렉토리에 있는 파일을 목록으려 가져옴
